...
namespace YimMenu::Submenus
{
	...
	void PedSpawnerGroup()
	{
		...
		static bool dead, invis, godmode, freeze, followPlayer, noFleeing, isArmed, isDrunk;
		...
		{
			FiberPool::Push([] {
				Peds::SpawnPed(pedModelBuffer, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Self::PlayerPed, 0, 3, 0), 0, freeze, dead, godmode, invis, scale, followPlayer, noFleeing, isArmed, isDrunk);
			});
		}
	}
